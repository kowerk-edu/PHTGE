...
In `kurs.json` sorgt `"featured": true` dafür, dass eine Kachel ganz oben über
die gesamte Breite erscheint. Bei **Aktuelles** ist diese Einstellung bereits
aktiv. Die Kachel bleibt wie alle anderen Bereiche auf- und zuklappbar.
