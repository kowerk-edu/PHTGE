...
Der Bereich **Klassenarbeiten** enthält nur zwei ausklappbare Sammlungen:

```text
materialien/07 Klassenarbeiten/01 Materialsammlung/
materialien/07 Klassenarbeiten/02 Klassenarbeitensammlung/
```

Allgemeine Übungs- und Vorbereitungsmaterialien kommen in die Materialsammlung. Frühere Klassenarbeiten oder Probeklausuren kommen in die Klassenarbeitensammlung.
